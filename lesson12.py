...
# 9. Дан список целых чисел [1, 2, 3, 6, 7, 11, 22, 44, 10, 12], найдите в нем число 10.
# Используйте цикл while.
# Если число найдено, выведите строку Число 10 найдено.
# Если число не найдено, то в блоке else выведите строку Число 10 не найдено.
...
# 2. Используйте continue, чтобы пропустить все гласные буквы во введенной строке.
