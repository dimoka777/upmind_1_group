# Урок 8: Кортежи и множества — основные операции
...
my_set = {1, 2, 3, 3, 3, 2} #  {1, 2, 3}
my_set_from_list = set([1, 2, 3, 55, 2, 33, 3, 1])  # int() str() bool()
...
# 32. Напиши программу, которая находит общие элементы во множестве (1, 2, 3) и (2, 3, 4).
...
# 38. Преобразуй кортеж во множество и найди его длину.
